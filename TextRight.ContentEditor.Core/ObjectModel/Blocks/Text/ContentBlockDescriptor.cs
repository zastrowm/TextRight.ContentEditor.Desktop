...
namespace TextRight.ContentEditor.Core.ObjectModel.Blocks
{
  ...
  /// </summary>
  public abstract class ContentBlockDescriptor
  {
    ...
    public abstract ContentBlock CreateInstance(DocumentOwner document);
  ...
  /// <summary> Generic version of <see cref="ContentBlockDescriptor"/> </summary>
  /// <typeparam name="TBlock"> Type of the block being described. </typeparam>
  public abstract class ContentBlockDescriptor<TBlock> : ContentBlockDescriptor
    where TBlock : ContentBlock, new()
  {
    /// <inheritdoc />
    public override ContentBlock CreateInstance(DocumentOwner document)
      => new TBlock();
